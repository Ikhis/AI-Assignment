...
# DATA PREPROCESSING, EXPLORATION, ANALYSIS AND VISUALIZATION
...
# Checks if the data is balanced using Countplot
sns.countplot(y='label', data=crops, hue='label', palette="plasma_r", legend=False)
plt.show()
...
sns.boxplot(y='label',x='ph',data=crops)
plt.show()
...
sns.countplot(x='label', data=crops, palette="plasma_r")
...
# Using Boxplot to visualize the effect of pH in crops
sns.boxplot(y='label', x='ph', data=crops)
plt.title("Effect of pH on Crop Types")
plt.show()
